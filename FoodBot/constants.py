...
GREETING = ("Привіт🙂! Вітаємо у Friendly food bot! "
            "Тут Ви зможете пригостити друзів смаколиками🍰, "
            "якщо немає можливості зустрітись із ними. "
            "Слідуйте вказівкам бота та станьте ближче до людей, які Вам не байдужі!😉")
