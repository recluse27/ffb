...
INSTRUCTION = ("Friendly food bot - це Facebook messenger бот, з допомогою "
               "якого Ви маєте можливість дарувати їстівні подарунки своїм друзям "
               "та знайомим з різних кафе та мереж харчування (наразі бот працює "
               "тільки у UNIT cafe, вул. Дорогожицька 1).\nОтже, для того, "
               "щоб пригостити друга Вам необхідно:\n1) Обрати позицію у меню, "
               "котра Вас цікавить. Для цього натисніть клавішу «Категорії» "
               "та оберіть із з’явившихся підкатегорій необхідну, наприклад, "
               "«Десерти».\n2) Натиснути клавішу «Додати» навпроти необхідної "
               "позиції, наприклад, «Чіз-кейк».\n3) Перевірити кошик. Для цього "
               "натисніть клавішу «Кошик» і перегляньте, чи відповідає вміст кошика "
               "тому, що Ви бажаєте придбати. Це не є обов’язковим, проте ми радимо "
               "перевіряти кошик за для того, щоб переконатися, що Ви додали саме те, "
               "що хотіли.\nЯкщо Ваші плани змінились - Ви можете видалити із кошика "
               "ту чи іншу позицію. Для цього натисніть клавішу «Видалити» навпроти "
               "необхідної позиції.\n4) Провести оплату за допомогою електронної картки. "
               "Натисніть клавішу «До оплати» та у з’явившемуся повідомленні натисніть "
               "«Перейти до оплати». Вас буде перенаправлено до системи електронних платежів "
               "LiqPay, де Вам буде запропоновано оплатити подарунок за допомогою електронної "
               "картки.\n5) Зробити подарунок! Після того, як Ви проведете оплату - "
               "бот надішле Вам три повідомлення. Перше - підтвердження Вашої операції і "
               "пояснення того, як подарувати придбаний смаколик. Друге - повідомлення, яке треба "
               "переслати Вашому другові, котрого Ви хочете пригостити. В цьому повідомленні буде міститись "
               "код замовлення і код підтвердження, які необхідно буде показати у закладі для отримання подарунку. "
               "Третє - чек.\n\nЗверніть увагу:\n- Ваш подарунок має бути використаний протягом 14 днів з моменту "
               "придбання. Про це буде написано у повідомленнях, котрі Ви отримаєте після оплати.\n- "
               "Замовлення не можна розбивати на декілька подарунків. Тобто, якщо Ви придбали за одну "
               "транзакцію декілька позицій з меню - це буде вважатися одним замовленням. Тому, "
               "якщо Ви хочете пригостити декількох людей.\n- Вам треба пройти пункти 1-5 стільки разів, "
